...
2. Define consent and purpose categories for plater/facility records.
...
- safety-critical escalation path (chemical exposure, ventilation
  failure, electrical hazard, equipment condition)
- provenance for all operating records (plater and facility both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  plating-operation-execution decision, a chemical-safety-clearance
